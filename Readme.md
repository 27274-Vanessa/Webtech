...
| Endpoint                           |  Method | Description                 | Screenshot                                                                                                       |
| ---------------------------------- | ------: | --------------------------- | ---------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/api/tasks`                       |     GET | Get all tasks               | [![Get all tasks](screenshoots/Get%20all%20tasks.png)](screenshoots/Get%20all%20tasks.png)                       |
| `/api/tasks/{taskId}`              |     GET | Get task by ID              | [![Get task by ID](screenshoots/Get%20task%20by%20ID.png)](screenshoots/Get%20task%20by%20ID.png)                |
| `/api/tasks/status?completed={true | false}` | GET                         | Get tasks by completion status                                                                                   | [![completed true](screenshoots/Get%20tasks%20by%20completion%20status.png)](screenshoots/Get%20tasks%20by%20completion%20status.png) [![completed false](screenshoots/Get%20tasks%20by%20completion%20status%20false%20.png)](screenshoots/Get%20tasks%20by%20completion%20status%20false%20.png) |
| `/api/tasks/priority/{priority}`   |     GET | Get tasks by priority       | [![priority](screenshoots/Get%20tasks%20by%20priority.png)](screenshoots/Get%20tasks%20by%20priority.png)        |
| `/api/tasks`                       |    POST | Create new task (JSON body) | [![create task](screenshoots/Create%20new%20task.png)](screenshoots/Create%20new%20task.png)                     |
| `/api/tasks/{taskId}`              |     PUT | Update task                 | [![update task](screenshoots/Update%20task.png)](screenshoots/Update%20task.png)                                 |
| `/api/tasks/{taskId}/complete`     |   PATCH | Mark task as completed      | [![mark complete](screenshoots/Mark%20task%20as%20completed.png)](screenshoots/Mark%20task%20as%20completed.png) |
| `/api/tasks/{taskId}`              |  DELETE | Delete task                 | [![delete task](screenshoots/Delete%20task.png)](screenshoots/Delete%20task.png)                                 |
